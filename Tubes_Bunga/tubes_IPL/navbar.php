        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="LoginUserFIX.html">Login User</a>
              <a class="dropdown-item" href="admin.html">Login Admin</a>
            </div>
          </li>

          <li class="nav-item active">
            <a class="nav-link" href="J_moobil.html">Jenis Mobil<span class="sr-only">(current)</span></a>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="Pembayaran dan antrian.html">Pembayaran</a>
              <a class="dropdown-item" href="strukpembayaran.html">Struk Pembayaran</a>
            </div>
          </li>
